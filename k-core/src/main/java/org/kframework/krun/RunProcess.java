...
public class RunProcess {
    ...
    @Inject
    public RunProcess(KExceptionManager kem, ProgramLoader loader) {
        this.kem = kem;
        this.loader = loader;
    }
    ...
    public ProcessOutput execute(File workingDir, Map<String, String> environment,String... commands) {
    ...
    public Term runParser(String parser, String value, boolean isNotFile, Sort startSymbol, Context context) throws ParseFailedException {
        ...
        switch (parser) {
            ...
            default: //external parser
                ...
                ProcessOutput output = this.execute(context.files.resolveWorkingDirectory("."), environment, tokens.toArray(new String[tokens.size()]));
