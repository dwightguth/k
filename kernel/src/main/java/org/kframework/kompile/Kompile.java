...
public class Kompile {
    ...
    private AtomicInteger parsedBubbles = new AtomicInteger(0);
    private AtomicInteger cachedBubbles = new AtomicInteger(0);
