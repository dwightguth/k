...
public class ProgramLoader {
     ...
     */
    public static ASTNode loadPgmAst(String content, String filename, Boolean kappize, Sort startSymbol, Context context) throws IOException,
    ...
    public static ASTNode loadPgmAst(String content, String filename, Sort startSymbol, Context context) throws IOException, ParseFailedException {
     ...
     */
    public static Term processPgm(String content, String filename, Sort startSymbol,
